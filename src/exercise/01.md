...
#### Key takeaway
Build up a web page out of a hierarcy of nodes using createElement and append:
1. `document.createElement(thisTag)`
2. `document.body.append(thisNode)` for root or
   `thisNode.append(thatNode)` for others

#### Tips
You generally don't need to conclude a line with semicolons, and it seems most
people don't.
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=01%3A%20Basic%20JavaScript-rendered%20Hello%20World&em=brett.deaton%40gmail.com).
